...
oll_wallet = False # если True то будет фармить на всех приватниках сразу
...
number_wallets = (0,1) # кошельки с которыми будем работать !!!!!!!!!!!!! НУМЕРАЦИЯ НАЧИНАЕТСЯ С НУЛЯ 0 . ЕСЛИ ВАМ НУЖНО 2 И 3 , ТО УКЗАЫВАЕТЕ 1,2   !!!!!!!!!!!!!! РАБОТАЕТ ТОЛЬКО need_random = True
